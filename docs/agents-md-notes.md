...
|---|---|---|
| **Claude Haiku 4.5** | ✅ Так, повною мірою | Реалізував `capitalize()` чистим функціональним стилем, тести логічні й назвисто, не додав коментар (що правильно — код очевидний). Дотримався конвенцій на 100%. |
