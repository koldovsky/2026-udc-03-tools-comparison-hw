...
|---|---|---|
| Вибір/якість моделі | Тільки моделі Anthropic: Opus 4.8, Sonnet 5, Haiku 4.5, Fable 5. Перемикання через `/model` у сесії. Через API також доступний на AWS Bedrock / Google Vertex AI | Мультивендорний: Claude (Anthropic), GPT (OpenAI), Gemini (Google) + власні моделі Composer і режим Auto (сам обирає модель). Модель обирається на кожен запит |
...
Друга суттєва відмінність — **вибір моделей**: Cursor мультивендорний
