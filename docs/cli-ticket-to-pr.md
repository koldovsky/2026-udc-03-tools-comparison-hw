...
Провалом на першому regex (`\b\w`) показав, що навіть простий функціонал потребує критичного тестування на край-кейсах (hyphenated words). Другий цикл — швидка переписування регулярного виразу для коректної поведінки.
